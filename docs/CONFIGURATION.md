...
| Key | Type | Default | Description |
|-----|------|---------|-------------|
| `appearance.theme` | `ThemeId` | `"system-acrylic"` | One of: `system`, `dark`, `light`, `dark-acrylic`, `light-acrylic`, `system-acrylic` |
| `appearance.accentColor` | `string` (hex) | `"#a785c7"` | UI accent color |
