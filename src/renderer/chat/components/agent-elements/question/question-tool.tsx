...
export function QuestionTool({ part }: QuestionToolProps) {
  ...
  return (
    <div className="rounded-an-tool-border-radius border border-border bg-an-tool-background overflow-hidden">
      <div className="h-7 border-b border-border px-3 flex items-center justify-between text-sm text-an-tool-color-muted">
      ...
      {isComplete ? (
        <div className="px-3 py-2 text-sm text-an-tool-color-muted bg-background">
          {summaryText}
        </div>
      ) : (
        <QuestionPrompt
