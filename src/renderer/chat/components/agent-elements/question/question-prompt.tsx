...
export function QuestionPrompt({
  ...
  return (
    <div className={cn("px-3 py-2 space-y-2 bg-background", className)}>
      ...
      >
        <div className="flex items-center gap-2 text-base text-an-tool-color">
          <span className="h-5 min-w-5 px-1 rounded-[4px] inline-flex items-center justify-center text-base font-medium text-an-tool-color-muted">
            {clampedIndex}
          </span>
      ...
      {activeQuestion.kind === "text" && (
        <textarea
          ...
          rows={3}
          className="w-full rounded-md border border-border bg-background px-2 py-1.5 text-base text-an-tool-color resize-y"
        />
      )}
          ...
          <div className="flex items-center gap-1.5">
            {onPreviousQuestion && (
              <button
                ...
                disabled={!canGoPrev}
                className="h-6 px-2 rounded-[4px] text-base text-muted-foreground hover:text-an-tool-color disabled:opacity-60"
              >
                Previous
              </button>
            )}
        ...
        <div className="flex items-center justify-end gap-1.5">
          {allowSkip && (
            <button
              type="button"
              onClick={handleSkip}
              className="h-6 px-2 rounded-[4px] text-base text-muted-foreground hover:text-an-tool-color hover:bg-muted/50 active:scale-[0.98] transition-[background-color,color,transform] duration-150"
            >
              {skipLabel}
            </button>
          )}
          <button
            ...
            disabled={!canSubmit}
            className="h-6 px-2.5 rounded-[4px] text-base font-medium bg-an-primary-color text-an-send-button-color hover:bg-an-primary-color/90 active:scale-[0.98] transition-[background-color,transform] duration-150 disabled:opacity-60 disabled:hover:bg-an-primary-color disabled:active:scale-100"
          >
            {primaryLabel}
          </button>
        </div>
