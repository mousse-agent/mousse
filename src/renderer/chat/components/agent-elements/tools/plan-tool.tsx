...
export const PlanTool = memo(function PlanTool({
  ...
  return (
    <div className="an-tool-chrome an-tool-plan rounded-an-tool-border-radius border border-border bg-an-tool-background overflow-hidden">
      ...
      <div className="border-t border-border bg-background pt-2">
        <div className="space-y-1.5">
          <div className="text-base text-an-tool-color px-3">{plan.title}</div>
          ...
          {hasSummary ? (
            <div className="relative">
              <div
                className={cn(
                  "px-3",
                  "text-base text-an-tool-color-muted",
                ...
                <div className="absolute inset-x-0 bottom-0 h-16 pb-2 pl-3.5 pr-2">
                  ...
                  <div className="h-full flex items-end justify-between relative">
                    <button
                      ...
                      className="-mx-2 h-5 px-1.5 rounded-[4px] text-sm text-muted-foreground hover:text-an-tool-color"
                    >
                      Read detailed plan
                    </button>
                    {!isAlreadyApproved && (
                      <button
                        ...
                        className="h-5 px-1.5 rounded-[4px] text-sm font-medium bg-an-primary-color text-an-send-button-color hover:bg-an-primary-color/90 active:scale-[0.98] transition-[background-color,transform] duration-150"
                      >
                        {approveText}
                      </button>
                    )}
