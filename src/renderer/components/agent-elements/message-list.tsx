...
import { IconCopy, IconCheck, IconInfoCircle, IconX } from "@tabler/icons-react";
import {
  formatResponseTime,
  formatTokens,
...
function MessageToolbar({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center gap-1 pt-1 text-xs text-an-foreground-muted/70 opacity-0 transition-opacity duration-100 pointer-events-none",
        heightClass,
        alignClass,
        hoverClass,
